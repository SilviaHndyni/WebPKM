...
<?php 
$stmt = $pdo_conn->prepare("SELECT * FROM warung ORDER BY nama DESC");
$stmt->execute();
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Data Tempat Makan</h4>
                                    <a href="index.php?admin=warung_form">
                                        ...
                                        <tbody>
                                            ...
                                            if(!empty($result)) { 
                                                ...
                                                <tr style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                                    ...
                                                    <td>
                                                    <a href="index.php?admin=warung_edit&id_warung=<?php echo $row['id']; ?>">
                                                    <button type="button" Style="margin-right:1rem;"class="btn btn-info">Edit</button></a>
                                                    <a href="warung_hapus.php?id_warung=<?php echo $row['id']; ?>" onclick="return confirm('Yakin Hapus?')"><button type="button" class="btn btn-warning">Hapus</button></a>
                                                    </td>
                                                </tr><?php
                                                } }
                                                ?>
