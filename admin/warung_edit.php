        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card strpied-tabled-with-hover">
                    ...
                    <form action="warung_update.php?id_warung=<?php echo $result[0]['id']; ?>&nama=<?php echo $result[0]['nama']; ?>" enctype="multipart/form-data" style="margin-left:4rem;" name="frmAdd" id="frmAdd" method="POST">
                        <label>nama: </label><br/>
