<?php 
    ...
    $stmt = $pdo_conn->prepare("SELECT * FROM warung where id=". $_GET["id_warung"]);
    $stmt->execute();
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card strpied-tabled-with-hover">
                    ...
                    <form action="warung_update.php?id_warung=<?php echo $result[0]['id']; ?>&nama=<?php echo $result[0]['nama']; ?>" enctype="multipart/form-data" class="mx-4" style="margin-left:4rem;" name="frmAdd" id="frmAdd" method="POST">
