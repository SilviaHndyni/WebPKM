...
<?php
    ...
    if(!empty($_POST["add_record"])) {
        ...
        $stmt1 = $pdo_conn-> prepare("SELECT * FROM warung ORDER BY id DESC LIMIT 1");
        $stmt1 -> execute();
        $result1 = $stmt1->fetchAll();
        
        $sql = "INSERT INTO warung (nama, alamat, link, deskripsi, gambar ) VALUES (:nama, :alamat, :link, :deskripsi, :gambar)";
